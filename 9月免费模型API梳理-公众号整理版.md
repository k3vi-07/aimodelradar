# 9 月免费大模型 API 梳理：24 个基础快照可测试，15 个需核实，9 个暂不推荐（新增：本月 AI 大事件月历）
...
## 二、基础快照总览（2026-09-21）：✅ 24 个可测试 / ⚠️ 15 个需核实 / ❌ 9 个暂不推荐
...
| ⚠️ | **白山智算 / PPIO / Nebius / Mistral / Anthropic / ModelScope / MiniMax / DeepSeek 官方 / 阶跃 / 面壁 / 天工 / 零一 / Novita / Together** | 详见第七章存疑清单（共 15 个） | — | — | — | — |
| ❌ | **Cerebras / GitHub Models / 无问芯穹 / 国家超算互联网 / OpenAI / xAI / DeepInfra / Replicate / 302.AI 系** | 详见第八章红名单（共 9 条） | — | — | — | AI21 除名、DeepSeek 移存疑 |

> ⚠️ 存疑条目完整清单见第七章，共 **15 个**；❌ 暂不推荐条目见第八章，共 **9 条**。"暂不推荐"只表示截至核查日不适合作为免费 API 方案，不代表平台本身不可用。
> 与 8 月对比：✅ 29 → 24（Cerebras 死亡、Kimi/白山/PPIO/Nebius 降级待核；百川 9-21 官方复核后回归；AI21/LongCat/TokenHub 入列）。免费渠道的总供给量并未下降，主要变化是**确定性收敛**——能官方核实口径的变少了。
